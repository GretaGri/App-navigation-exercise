            ...
            if (-1 != checkedId) {
                ...
                if (answers[answerIndex] == currentQuestion.answers[0]) {
                    ...
                    if (questionIndex < numQuestions) {
                        ...
                        // Done (03) Replace the action ID for the game won state with GameFragmentDirections
                        // GameFragmentDirections.actionGameFragmentToGameWonFragment
                        // Done (07) Add the newly-added parameters to the constructor for the Directions
                        // numQuestions and questionIndex
                        view.findNavController().navigate(GameFragmentDirections.actionGameFragmentToGameWonFragment(numQuestions,questionIndex))
                    }
                } else {
                    // Game over! A wrong answer sends us to the gameOverFragment.
                    // Done (04) Replace the action ID for the game over state with GameFragmentDirections
