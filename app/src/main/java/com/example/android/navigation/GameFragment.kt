            ...
            if (-1 != checkedId) {
                ...
                if (answers[answerIndex] == currentQuestion.answers[0]) {
                    ...
                    if (questionIndex < numQuestions) {
                        ...
                        // Done (05) Find the navController from the view and navigate to the gameWonFragment
                    ...
                    // Done(06) Find the navController from the view and navigate to the gameOverFragment
                    // call view.findNavController
